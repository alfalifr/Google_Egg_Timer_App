...
import com.example.android.eggtimernotifications.util.cancellAllNotif
    ...
    private fun startTimer(timerLengthSelection: Int) {
        _alarmOn.value?.let {
            if (!it) {
                ...
                val notifManager = app.getSystemService<NotificationManager>()!!

                // TODO: Step 1.15 call cancel notification
                notifManager.cancellAllNotif()
